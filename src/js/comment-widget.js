/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="./src/js/comment-widget.js"></script>

    Have fun! Bug reports are encouraged if you happen to run into any issues.
    - Ayano (https://virtualobserver.moe/)
*/
const s_stylePath = '/src/css/comment-widget-dark.css';
const s_formId = '1FAIpQLSeq-44nETiLGhUlZ6gZbufahGrjZgzX-qkvUR2GMoxChu-J8Q';
const s_nameId = '179197200';
const s_websiteId = '328365027';
const s_textId = '308782318';
const s_pageId = '562656267';
const s_replyId = '1387112868';
const s_sheetId = '1Bi-wFDka5W-CKeiC_mys-I8wQ5y8mRA2v2sPg2GrrUo';
...
const s_maxLength = 600; //char length of comments
const s_maxLengthName = 24;
...
//wording filter - profanity censorship
...
const s_websiteFieldLabel = 'Website (if any)';
...
const s_websiteText = 'Site' // Links to sites left byu users
const s_replyButtonText = 'Reply!'; // the button to reply
